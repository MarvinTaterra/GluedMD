...
STAGES = [
    ...
    # KV1.2 (168k atoms, POPC:POPG bilayer): the simultaneous dt=0.001→0.002
    # jump AND restraint softening at stage 6.4 caused NaN. Keep dt=0.001
    # throughout the rest of equilibration — adds ~20 min wall but eliminates
    # the instability. Step counts doubled to maintain physical duration.
    ("6.4 NPT",  500_000, 0.001, True,      0, False,  500.,  200.,  200.,  200.),
    ("6.5 NPT",  500_000, 0.001, True,      0, False,  200.,   50.,   40.,  100.),
    ("6.6 NPT",  500_000, 0.001, True,      0, False,   50.,    0.,    0.,    0.),
]
